...
fun TvShowEntity.toDomain() = TvShow(posterPath, popularity, id, backdropPath, voteAverage, overview, firstAirDate, listOf(originCountry), listOf(genreIds), originalLanguage, voteCount, name, originalName)